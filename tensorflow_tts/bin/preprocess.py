...
from tensorflow_tts.processor import SceTTSProcessor
...
from tensorflow_tts.processor.scetts import SCETTS_SYMBOLS
...
def parse_and_config():
    ...
    parser.add_argument(
        ...
        type=str,
        default="ljspeech",
        choices=["ljspeech", "kss", "scetts", "libritts", "baker", "thorsten"],
